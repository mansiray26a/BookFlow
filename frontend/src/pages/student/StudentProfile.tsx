      ...
      <Card className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs">
          ...
          <div className="space-y-1">
            ...
            <p className="font-mono font-bold text-slate-900 dark:text-white">{user.studentProfile?.rollNumber || 'CS2024001'}</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="font-medium text-slate-900 dark:text-white">{user.studentProfile?.department || 'Computer Science'}</p>
          </div>
        ...
        <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-xs space-y-1">
          <span className="font-bold text-slate-700 dark:text-slate-300">Borrowing Policy Quota:</span>
          <p className="text-slate-500">Maximum concurrent loans: 3 books | Default loan duration: 14 days | Max renewals: 2</p>
        </div>
      </Card>
    </div>
  );
